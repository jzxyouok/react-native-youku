...
YY_EXTERN NSString *const kYYScreenChangeButtonClickedNotification; // 点击最大化最小化按钮的通知
...
typedef NS_ENUM(NSInteger, YYErrorCode) {
    ...
    YYErrorPermissionDeny   = -111,      // 视频无权限播放（优酷独播）

    YYErrorOnlyForVIP       = -112,      // 优酷会员专享
    
    YYErrorInitOpenView     = -113,      // 初始化界面无效
    
    YYErrorBundleTempered   = -114,      // 篡改资源
        
    YYErrorIpInvalied       = -116,      // ip地址无效或受限制
    
    YYErrorDownloadForbidden  = -117,      // 禁止下载
